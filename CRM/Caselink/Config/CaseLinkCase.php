...
class CRM_Caselink_Config_CaseLinkCase {
  ...
  protected function __construct() {
    $this->custom_group = civicrm_api3('CustomGroup', 'getsingle', array('name' => 'caselink_case'));
    $this->case_id = civicrm_api3('CustomField', 'getsingle', array('name' => 'case_id', 'custom_group_id' => $this->custom_group['id']));
  }

  /**
   * @return CRM_Caselink_Config_CaseLinkCase
   */
  public static function singleton() {
    if (!self::$singleton) {
      self::$singleton = new CRM_Caselink_Config_CaseLinkCase();
    }
